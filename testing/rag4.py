...
def get_answer(question, context):
    ...
    If you don't have enough information, say so and explain why. Only write in one sentence.
...
def process_input(input_text):
    ...
    if full_query_content and full_query_content not in retrieved_articles:
        ...
        print(f"Article for '{input_text}' already utilized")
    else:
    ...
    for entity in entities:
        ...
        if content and content not in retrieved_articles:
            ...
            print(f"Article for '{content}' already utilized")
        else:
...
test_cases = [
    ...
    "Trump doesn't believe in Covid-19.",
    "The Earth is flat."
]

input_text = "Trump doesn't believe in Covid-19."
